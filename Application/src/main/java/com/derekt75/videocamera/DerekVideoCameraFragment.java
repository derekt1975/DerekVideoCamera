...
public class DerekVideoCameraFragment extends Fragment
    ...
    private static final String TAG = "VideoCameraFragment";
    ...
    public static DerekVideoCameraFragment newInstance() {
        return new DerekVideoCameraFragment();
    }
    ...
    private String getVideoFilePath(Context context) {
        ...
        File newFile = new File(file,"DerekCamera");
        if (!newFile.exists()) {
            Log.d(TAG, "Folder doesn't exist, creating it...");
            boolean rv = newFile.mkdirs();
        ...
        imageFileName = (newFile == null ? "" : (newFile.getAbsolutePath() + "/"))
                + imageFileName + ".mp4";
    ...
    private void stopRecordingVideo() {
        ...
        if (null != activity) {
            ...
            MediaScannerConnection.scanFile(getContext(),
                    new String[] { mNextVideoAbsolutePath }, null, null);
